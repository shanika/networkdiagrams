      ...
      init : function( options ) {
        ...
        $(uniqueForms).bind("submit.validationSubmit", function (e) {
          ...
          $allControlGroups.each(function (i, el) {
            var $controlGroup = $(el);
            if ($controlGroup.hasClass("info") || $controlGroup.hasClass("warning")) {
              $controlGroup.removeClass("info").addClass("warning");
              warningsFound++;
            }
          });
          ...
          $this.bind(
            ...
            function (e, params) {
              ...
              if (errorsFound.length) {
                ...
                $controlGroup.removeClass("success warning info").addClass(formIsSubmitting ? "warning" : "info");
                ...
                $controlGroup.removeClass("info warning success");
                if (value.length > 0) {
      ...
      number: {
		...
		builtInValidators: {
			...
			required: {
				name: "Required",
				type: "required",
				message: "This is a required field<!-- data-validator-required-message to override -->"
			},
			checkone: {
				name: "Checkone",
				type: "minchecked",
