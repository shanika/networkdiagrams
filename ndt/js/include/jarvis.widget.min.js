(function ($, window, document, undefined) {
            ...
            if (storage && self.o.localStorage && getKeySettings) {
                ...
                for (var key in jsonSettings.widget) {
                    ...
                    if (jsonSettings.widget[key].style) {
                        widgetId.addClass(jsonSettings.widget[key].style).attr("data-widget-attstyle", "" + jsonSettings.widget[key].style + "")
                    }
            ...
            self.widget.each(function () {
                ...
                if (!thisHeader.parent().attr("role")) {
                    ...
                    if (self.o.customButton === true && tWidget.data("widget-custombutton") === undefined && self.customClass[0].length != 0) {
                        var customBtn = '<a href="#" class="button-icon btn jarviswidget-custom-btn"><i class="' + self.customClass[0] + '"></i></a>'
                    } else {
                        customBtn = ""
                    } if (self.o.deleteButton === true && tWidget.data("widget-deletebutton") === undefined) {
                        var deleteBtn = '<a href="#" class="button-icon btn jarviswidget-delete-btn"><i class="' + self.o.deleteClass + '"></i></a>'
                    } else {
                        deleteBtn = ""
                    } if (self.o.editButton === true && tWidget.data("widget-editbutton") === undefined) {
                        var editBtn = '<a href="#" class="button-icon btn jarviswidget-edit-btn"><i class="' + self.editClass[0] + '"></i></a>'
                    } else {
                        editBtn = ""
                    } if (self.o.fullscreenButton === true && tWidget.data("widget-fullscreenbutton") === undefined) {
                        var fullscreenBtn = '<a href="#" class="button-icon btn jarviswidget-fullscreen-btn"><i class="' + self.fullscreenClass[0] + '"></i></a>'
                    } else {
                        fullscreenBtn = ""
                        ...
                        var toggleBtn = '<a href="#" class="button-icon btn jarviswidget-toggle-btn"><i class="' + toggleSettings + '"></i></a>'
                    } else {
                        toggleBtn = ""
                    } if (self.o.refreshButton === true && tWidget.data("widget-refreshbutton") != false && tWidget.data("widget-load")) {
                        var refreshBtn = '<a href="#" class="button-icon btn jarviswidget-refresh-btn"><i class="' + self.o.refreshButtonClass + '"></i></a>'
                    } else {
                        refreshBtn = ""
                    }
                    ...
                    if (tWidget.find(self.o.editPlaceholder).length) {
                        tWidget.find(self.o.editPlaceholder).find("input").val(thisHeader.children("h2").text())
                    }
                    thisHeader.append('<span class="jarviswidget-loader"><i class="icon-spinner icon-spin"></></span>');
        ...
        _clickEvents: function () {
            ...
            function heightFullscreen() {
                if ($("#jarviswidget-fullscreen-mode").length) {
                    ...
                    $("#jarviswidget-fullscreen-mode").find(self.o.widgets).children("div").height(heightWindow - heightHeader - 3)
                }
            }
    ...
    $.fn[pluginName].defaults = {
        ...
        buttonsHidden: false,
        toggleButton: true,
        toggleClass: "icon-collapse-top| icon-collapse",
        toggleSpeed: 200,
        onToggle: function () {},
        deleteButton: true,
        ...
        editClass: "icon-edit | icon-edit-sign",
        editSpeed: 200,
        onEdit: function () {},
