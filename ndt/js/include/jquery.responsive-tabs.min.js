...
;(function ( $, window, document, undefined ) {
    ...
    function Plugin(element, options) {
        ...
        function setSmallStyle() {
            ...
            $("<a class='right tab-control'><i class='icon-chevron-sign-right'></i></a>").appendTo($(".nav-tabs li:not(:last-child)",$el))
              .each(function(i){
            ...
            $("<a class='left tab-control'><i class='icon-chevron-sign-left'></i></a>").prependTo($(".nav-tabs li:not(:first-child)",$el))
              .each(function(i){
    ...
    $.fn[pluginName].defaults = {
        maxSmallWidth: 480,   // biggest screen size for which we use "small" configuration
