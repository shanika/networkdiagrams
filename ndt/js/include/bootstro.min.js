...
$(document).ready(function(){
    ...
    (function( bootstro, $, undefined ) {
        ...
        var defaults = {
            ...
            //nextButton : '<button class="btn bootstro-next-btn">Next &raquo;</button>',
            prevButtonText : '&laquo; Prev',
            //prevButton : '<button class="btn bootstro-prev-btn">&laquo; Prev</button>',
        ...
        function add_nav_btn(content, i)
        {
            ...
            {
                nextButton = '<button class="btn bootstro-next-btn">' + $el.attr('data-bootstro-nextButtonText') +  '</button>';
            }
            else 
            {
                if (typeof settings.nextButton != 'undefined' /*&& settings.nextButton != ''*/)
                    ...
                    nextButton = '<button class="btn bootstro-next-btn">' + settings.nextButtonText + '</button>';
            }
            ...
            {
                prevButton = '<button class="btn bootstro-prev-btn">' + $el.attr('data-bootstro-prevButtonText') +  '</button>';
            }
            else 
            {
                if (typeof settings.prevButton != 'undefined' /*&& settings.prevButton != ''*/)
                    ...
                    prevButton = '<button class="btn bootstro-prev-btn">' + settings.prevButtonText + '</button>';
            }
            ...
            {
                finishButton = '<a href="javascript:void(0)" class="btn bootstro-finish-btn">' + $el.attr('data-bootstro-finishButtonText') +  '</a>';
            }
            else 
            {
                if (typeof settings.finishButton != 'undefined' /*&& settings.finishButton != ''*/)
                    ...
                    finishButton = '<a href="javascript:void(0)" class="btn bootstro-finish-btn">' + settings.finishButtonText + '</a>';
            }
        ...
        get_popup = function(i)
        {
            ...
            if (count > 1)
            {
                t = "<span class='label label-info'>" + (i +1)  + "/" + count + "</span>";
            }
            ...
            p.template = '<div class="popover tour" style="' + style + '"><div class="arrow"></div><div class="popover-inner"><h3 class="popover-title"></h3><div class="popover-content"><p></p></div></div>' +
             '</div>';
